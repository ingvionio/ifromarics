    ...
    public partial class FromDec : Form
    {
        ...
        private void NextStep_Click(object sender, EventArgs e)
        {
            ...
            else if (stepNum == 1)
            {
                if (baseNumber > 10)
                {
                    startWindowText.Text = "Осталось одно маленькое преобразование. Если остаток получился больше 10 (такое может произойти если основание системы, в которую мы переводим больше 10), то нужно этот остаток заменить на символ соответсвующий этому числу. Для числел  с 11 до 36 это заглавные буквы английского алфавита, а для чисел с 37 до 62 это строчные буквы английского алфавита.)";
                }
                else
                {
