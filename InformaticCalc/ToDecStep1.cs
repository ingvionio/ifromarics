...
namespace InformaticCalc
{
    ...
    public partial class Answer : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                ans.Text = null;
                startWindowText.Text = "У каждого разряда есть свой номер. Он нам пригодитсяч для перевода числа в десятичную систему. Нумерация начинается с самой правой цифры числа, поэтому для дальнейшего удобства давай перевернём число (запишем его справа навлево)";
